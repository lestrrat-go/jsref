...
* 💬 Open-ended questions and inquiries go to [Discussions](https://github.com/lestrrat-go/jsref/discussions).
* 🖥️ Actionable, specific technical questions go to [Issues](https://github.com/lestrrat-go/jsref/issues).
...
This project uses [GitHub Issues](https://github.com/lestrrat-go/jsref/issues) to deal with technical issues
...
questions/discussions should be posted to [GitHub Discussions](https://github.com/lestrrat-go/jsref/discussions).
